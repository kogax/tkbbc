...
describe BoardsController do
  ...
  let(:valid_attributes) { {title: 'valid_title'} }
  let(:invalid_attributes) { {title: 'a'*101 } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested board" do
        ...
        Board.any_instance.should_receive(:update).with({ "title" => 'update_title' })
        put :update, {:id => board.to_param, :board => { "title" => 'update_title' }}, valid_session
      end
